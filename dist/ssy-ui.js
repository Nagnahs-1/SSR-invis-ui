import { defineComponent, createVNode, openBlock, createElementBlock, normalizeClass, normalizeStyle } from "vue";
const version = "0.2.0";
...
function avatarPlugin(app) {
  app.component("Avatar", _sfc_main);
}
const plugins = [Link, Button, avatarPlugin];
